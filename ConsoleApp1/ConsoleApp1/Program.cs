            ...
            if (registros != null)
            {
                ...
                {   
                    if (registro.conexoes != null)
                    {
                        ...
                        cmd.CommandText = "declare @x table (id int); insert into Registro (idFirebase, sala, setor) output inserted.id into @x values (@fire, @sala, @setor); select id from @x";
                        ...
                        foreach (Conexo conexo in registro.conexoes)
                        {
                            ...
                            cmd.CommandText = @"insert into Conexao (bssid, rssi, ssid, idRegistro) values
